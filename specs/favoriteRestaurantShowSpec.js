...
import FavoriteRestaurantIdb from '../src/scripts/data/restaurant-favorit';
...
describe('Showing all favorite restaurants', () => {
  ...
  describe('When favorite restaurants exist', () => {
    it('should show the restaurants', (done) => {
      document.getElementById('restaurants').addEventListener('restaurants:updated', () => {
        expect(document.querySelectorAll('.container__restaurant').length).toEqual(2);
        done();
      });
      ...
      favoriteRestaurants.getAllRestaurants.and.returnValues([
        {
          ...
          city: 'San Francisco',
          rating: 3,
          description: 'Ini adalah restaurant A',
        },
        {
          id: 22,
          name: 'Restaurant B',
          city: 'San Francisco',
          rating: 4,
          description: 'Ini adalah restaurant B',
        },
      ]);
      // eslint-disable-next-line no-new
      new FavoriteRestaurantShowPresenter({
